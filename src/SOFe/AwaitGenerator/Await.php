...
class Await extends PromiseState{
	...
	/**
     * Run the coroutine to completion and return the final result synchronously.
     *
     * @return mixed The final resolved value of the generator.
     * @throws Throwable If the coroutine throws an exception.
     */
    public function run() 
	{
        while ($this->generator->valid()) {
            $this->wakeupFlat([$this->generator, "next"]);
        }

        // Return the final resolved value or throw the exception
